...
with upload:
  ...
  if file is not None:
    ...
    with annotation:
        ...
        Activity_1_Start_Time = st.slider("Activity 1 Start Time", step = 1, min_value = 0, max_value = len(data))
        ...
        Activity_2_Start_Time = st.slider("Activity 2 Start Time", step = 1, min_value = 0, max_value = len(data))
        Activity_2_Finish_Time = st.slider("Activity 2 End Time", step = 1, min_value = 0, max_value = len(data))
        st.success("Activity 3")
        Activity_3 = st.text_input("Activity 3")
        Activity_3_Start_Time = st.slider("Activity 3 Start Time", step = 1, min_value = 0, max_value = len(data))
        Activity_3_Finish_Time = st.slider("Activity 3 End Time", step = 1, min_value = 0, max_value = len(data))
